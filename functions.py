...
def use_loot(belt, health_points):
    ...
    # You can also add more craftable items or functions here as needed
...
def craft_item(character):
    print("Crafting Menu:")
    print("1. Healing Gloves (Health Potion + Flimsy Gloves)")
    choice = input("Enter the number of the item you want to craft: ")

    if choice == '1':
        if 'Health Potion' in character.inventory and 'Flimsy Gloves' in character.inventory:
            character.inventory.remove('Health Potion')
            character.inventory.remove('Flimsy Gloves')
            character.inventory.append('Healing Gloves')
            print("You crafted Healing Gloves!")
        else:
            print("You don't have the required items to craft Healing Gloves.")
    else:
